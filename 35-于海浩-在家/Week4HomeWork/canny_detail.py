...
if __name__ == '__main__':
    ...
    plt.subplot(231), plt.imshow(img_new.astype(np.uint8), "gray"), plt.title("img_new")
    plt.subplot(232), plt.imshow(img_tidu.astype(np.uint8), "gray"), plt.title("img_tidu")
    plt.subplot(233), plt.imshow(img_yizhi2.astype(np.uint8), "gray"), plt.title("img_yizhi")
    plt.subplot(234), plt.imshow(img_yizhi.astype(np.uint8), "gray"), plt.title("boundary")
